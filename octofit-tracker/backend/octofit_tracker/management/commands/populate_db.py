...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        Activity.objects.create(user='batman', activity_type='Bike', duration=60, team='DC')
        ...
        Workout.objects.create(name='Agility Boost', description='Agility training for heroes', suggested_for='DC')
